...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <h6>Actulizar reserva</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('reservas.update',$reserva->id) }}" method="POST" role="form text-left"
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nombrereserva" class="form-control" id="nombrereserva" value="{{ $reserva->nombre }}" require>
                        </div>
                        <div class="col-md-4">
                            <label for="precioreserva" class="form-label">Precio</label>
                            <input type="number" name="precioreserva" class="form-control" id="precioreserva"  value="{{ $reserva->precio }}">
                        </div>
                        <div class="col-md-4">
                            <label for="fechainireserva" class="form-label">Fecha Inicio</label>
                            <input type="date" name="fechainireserva" class="form-control" id="fechainireserva" value="{{ $reserva->fecha_ini}}" require>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="fechafinreserva" class="form-control" id="fechafinreserva"
                                value="{{ $reserva->fecha_fin }}" require>
                        </div>
                    </div>
                    <div class="mb-3">
