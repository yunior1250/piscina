...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="card mb-4" style="margin-top: 50px;">
            ...
            <div class="card-body">
                <form action="{{ route('ambientes.store') }}" method="POST" role="form text-left"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="nombreambiente" class="form-label">Nombre del ambiente</label>
                            <input type="text" name="nombreambiente" class="form-control" id="nombreambiente" require>
                        </div>
                        <div class="col-md-4">
                            <label for="capacidadambiente" class="form-label">Capacidad</label>
                            <input type="number" name="capacidadambiente" class="form-control" id="capacidadambiente" require>
                        </div>
