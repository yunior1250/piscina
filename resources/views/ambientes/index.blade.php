...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        {{-- ambientessssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss --}}
                            ...
                            <div class="col-md-4 mb-4 ">
                                <div class="card bg-info" style="margin-right: 1rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text" style="color: #ffffff;">{{ $ambiente->descripcion }}</p>
                                        <p class="card-text"style="color: #ffffff;">{{ $ambiente->direccion }}
                                        </p>
                                        <p class="card-text"style="color: #ffffff;">{{ $ambiente->fecha }}
                                        </p>
                                        <p class="card-text" style="color: #ffffff;">{{ $ambiente->hora }}
                                        </p>
