...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="card mb-4" style="margin-top: 50px;">
            ...
            <div class="card-body">
                <form action="{{ route('sucursales.update',$sucursal->id) }}" method="POST" role="form text-left"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <label for="telefonosucursal" class="form-label">Numero</label>
                            <input type="number" name="telefonosucursal" class="form-control" id="telefonosucursal" value="{{ $sucursal->telefono }}" require>
                        </div>
                        <div class="col-md-4">
                            <label for="direccionsucursal" class="form-label">Direccion</label>
                            <input type="text" name="direccionsucursal" class="form-control" id="direccionsucursal" value="{{ $sucursal->direccion }}" require>
                        </div>
                    </div>
                    ...
                    --}}
                    <button type="submit" class="btn btn-info">Actualizar Sucursal</button>
                </form>
            </div>
        </div>
    </div>
